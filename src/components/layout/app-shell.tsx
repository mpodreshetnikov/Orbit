...
import { useEnsurePushSubscription, useNotifications } from "@/hooks";
  ...
  return (
    <div className="min-h-screen min-w-0 w-full max-w-full overflow-x-hidden bg-background">
      ...
      <div className="flex min-w-0 w-full max-w-full">
        ...
        <main className="flex-1 min-w-0 w-full max-w-full md:pl-64 pl-[var(--safe-area-inset-left)] pr-[var(--safe-area-inset-right)] pt-[calc(4rem+var(--safe-area-inset-top))] pb-[calc(4.5rem+var(--safe-area-inset-bottom)+4rem)] md:pt-16 md:pb-0">
