...
describe("GET /api/extension-release/latest", () => {
  ...
  it("returns normalized latest extension release metadata", async () => {
  ...
  it("returns 404 when latest release metadata is not published yet", async () => {
    const download = vi.fn().mockResolvedValue({
      data: null,
