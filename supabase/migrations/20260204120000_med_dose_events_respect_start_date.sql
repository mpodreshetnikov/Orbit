-- ============================================================================
-- Respect regimen start_date for all schedule types
-- ============================================================================
-- Intakes are generated only on or after duration.start_date for:
-- - interval_hours: slot loop starts from greatest(start_date, today); skip slots before start_date
-- - daily_times, days_of_week, interval_days: skip dates before start_date in the date loop
-- ============================================================================
