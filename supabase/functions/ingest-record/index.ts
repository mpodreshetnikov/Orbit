...
- Используй СТАНДАРТНЫЕ медицинские названия для улучшения поиска
- Примеры хороших заголовков: "Общий анализ крови", "УЗИ брюшной полости", "Консультация терапевта", "Биохимический анализ крови"
...
- Используй СТАНДАРТНЫЕ русские медицинские термины для улучшения поиска
- Нормализуй сокращения и аббревиатуры в полные названия
- Примеры нормализации:
  * ОАК → общий анализ крови
  * БХ, биохимия → биохимический анализ
  * ОАМ → общий анализ мочи
  * УЗИ → ультразвуковое исследование (но "УЗИ" тоже допустимо как общепринятое)
  * ЭКГ → электрокардиограмма
  * МРТ → магнитно-резонансная томография
  * КТ → компьютерная томография
  * Hb, гемоглобин → гемоглобин
  * RBC, эритроциты → эритроциты
  * WBC, лейкоциты → лейкоциты
- Используй общепринятые русские медицинские термины, а не латинские или английские. Допустимо использовать общепринятые в России нерусские наименования, например, для витаминов: B12, C, D и тд
