...
-- ON CONFLICT (payer_person_id, dedupe_hash). Both targets are scoped to the person, matching the
-- unique indexes: transaction identity belongs to one person, not to the whole registry.
