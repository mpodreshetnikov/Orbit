...
It is the successor to [`T-0006`](./T-0006-health-image-recognition-pipeline-hardening.md), whose Milestone 8 built the scored regression corpus that found everything below. That plan is checked in and is incorporated here by reference; you do not need to read it to execute this one, because every fact this plan relies on is restated here.
