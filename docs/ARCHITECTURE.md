...
| `ARCH-G06` | Documentation map drift in rules/plans locations — resolved 2026-08-13 | Slows onboarding and creates ambiguity on canonical planning paths                          | Was: `AGENTS.md` referenced `docs/PLANS.md/` while planning content was split across `docs/PLANS.md` and `docs/exec-plans/`. Resolved by unifying all work into `docs/tasks/`, with `docs/tasks/README.md` canonical for where work lives and `docs/PLANS.md` canonical for how to write a plan; `tasks-check` gates the layout. See `docs/tasks/decisions/ADR-0001-unified-task-registry.md`. |
